...
selective_scan_cuda_core_fwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    DISPATCH_ITYPE_FLOAT_AND_HALF_AND_BF16(u.scalar_type(), "selective_scan_cuda_core_fwd", [&] {
...
selective_scan_cuda_core_bwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    at::cuda::CUDAGuard device_guard{(char)u.get_device()};
    auto stream = at::cuda::getCurrentCUDAStream().stream();
    DISPATCH_ITYPE_FLOAT_AND_HALF_AND_BF16(u.scalar_type(), "selective_scan_cuda_core_bwd", [&] {
